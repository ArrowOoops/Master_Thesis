...
\ustcsetup{
  title              = {基于深度学习的中文医学文本\\生成任务的隐私保护研究},
  title*             = {Research on Privacy Protection of Chinese Medical Text Generation Task Based on Deep Learning},
  author             = {揭一新},%揭一新
  author*            = {Jie Yixin},%Jie Yixin
  speciality         = {网络空间安全},
  speciality*        = {School of Cyber Science and Technology},
  supervisor         = {张驰 副教授},%张驰 副教授
  supervisor*        = {Prof. Zhang Chi},%Prof. Zhang Chi
